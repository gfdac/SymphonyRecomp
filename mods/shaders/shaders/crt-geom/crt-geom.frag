...
// crt-geom, adapted for RecompOne, original source is available at https://github.com/libretro/glsl-shaders/blob/master/crt/shaders/crt-geom.glsl
...
#       define TEX2D(c) pow(texture(Texture, (c)), vec4(CRTgamma))
#else
#       define TEX2D(c) texture(Texture, (c))
#endif
...
void main()
{
	...
	mod_factor = TEX0.x * TextureSize.x * OutputSize.x / InputSize.x;
